...
CREATE TABLE "funding_source_goals" (
	"id" serial PRIMARY KEY NOT NULL,
...
CREATE TABLE "funding_sources" (
	...
	"narrative_file_name" varchar(255),
	"start_date" date,
	"end_date" date,
	"amount" numeric(12, 2),
...
CREATE TABLE "learner_statuses" (
	...
	CONSTRAINT "learner_statuses_name_unique" UNIQUE("name")
);
--> statement-breakpoint
...
CREATE TABLE "programs" (
	"id" serial PRIMARY KEY NOT NULL,
	"name" varchar(255) NOT NULL,
	"programTag" varchar(100) NOT NULL,
	"description" text NOT NULL,
	...
	"pathways" jsonb,
	CONSTRAINT "programs_programTag_unique" UNIQUE("programTag")
);
--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "funding_source_goals" ADD CONSTRAINT "funding_source_goals_funding_source_id_funding_sources_id_fk" FOREIGN KEY ("funding_source_id") REFERENCES "public"."funding_sources"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "learner_roadmaps" ADD CONSTRAINT "learner_roadmaps_learnerId_learners_id_fk" FOREIGN KEY ("learnerId") REFERENCES "public"."learners"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "success_stories" ADD CONSTRAINT "success_stories_learner_id_learners_id_fk" FOREIGN KEY ("learner_id") REFERENCES "public"."learners"("id") ON DELETE set null ON UPDATE no action;